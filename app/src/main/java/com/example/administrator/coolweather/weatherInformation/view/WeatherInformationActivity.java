...
import com.example.administrator.coolweather.weatherInformation.adapter.HourlyWeatherAdapter;
...
//        hourlyWeather = findViewById(R.id.hourly_weather);
//        hourlyWeather.setLayoutManager(linearLayoutManager);
    ...
    @Override
    public void setHourlyWeatherInfo(HourlyWeather info) {
//        Log.d(TAG,"hourly");
//        HourlyWeatherAdapter hourlyWeatherAdapter = new HourlyWeatherAdapter(info);
